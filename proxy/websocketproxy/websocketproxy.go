...
type WebsocketProxy struct {
	...
	UserSessions map[string]dockermanager.DockerSession
...
func ProxyHandler(UserSessions map[string]dockermanager.DockerSession) http.Handler {
	return NewProxy(UserSessions)
}

// NewProxy returns a new Websocket reverse proxy that rewrites the
// URL's to the scheme, host and base path provider in target.
func NewProxy(UserSessions map[string]dockermanager.DockerSession) *WebsocketProxy {
